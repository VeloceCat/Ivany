    ...
    public override void StartTalking(int num)
    {
        ...
        switch (num)
        {
            ...
            case 1:
                ...
                int rnd = Random.Range(1, 6); //range is dus 1-5, chain wordt 2-6
                chain = rnd-1;
                numberOfOptions = 1;
                option01Text = "...";
                break;
            ...
            case 2:
                narrativeText = "Er is niemand thuis als je binnen komt. Dus neem je eet je een appel en gaat naar je kamer.";
                endOfEvent = true;
                break;
