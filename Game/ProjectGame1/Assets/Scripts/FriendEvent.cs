...
public class FriendEvent : ChoiceScript {

    [SerializeField]
    protected SchoolController schoolControl;
    ...
    public override void StartTalking(int num)
    {
        ...
        switch (num)
        {
            ...
            case 18:
                narrativeText = "\"Daarna gaan we voor jou zorgen, vandaag ga ik geen les geven en jullie 2 hoeven niet naar de les.Ik zal met jullie meegaan naar de politie.\"";
                moodValue = 5;
                endOfEvent = true;
                break;
