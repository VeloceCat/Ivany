...
public class School_Events : ChoiceScript {
    ...
    public override void StartTalking(int num)
    {
        ...
        switch (num)
        {
            ...
            case 2:
                narrativeText = "Vandaag was er een leerkracht jarig. Een klein feestje in de klas en een leuke les.";
                moodValue = 5;
                endOfEvent = true;
                break;

            case 3:
                narrativeText = "Je ziet tijdens de middagpauze een groepje leerlingen die je niet kent naar jou kijken en lachen. Maar je hebt geen idee waarom.";
                moodValue = -5;
                endOfEvent = true;
                break;
            ...
            case 14:
                narrativeText = "Dan maar gewoon negeren en je wandel naar je lokaal. Geen reactie, geen plezier blijkbaar want je achtervolger geeft al snel op.";
                moodValue = -5;
                endOfEvent = true;
                break;
