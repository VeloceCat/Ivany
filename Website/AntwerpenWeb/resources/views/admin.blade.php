...
@section('content')
    ...
    if(null !== Auth::user()) {
        if(Auth::user()->is_admin == 1) {
            ...
            echo ($postCount = DB::table('posts')->where('is_allowed', '=', 0)->count());

            buttonActive(6,$infoNummer);
            echo ($commentCount = DB::table('comments')->where('is_allowed', '=', 0)->count());
    ...
    { 
        ...
        switch($variabele)
        {
            ...
            case 2:
                ...
                case 7:
                    echo "  <table id='myTable'><tr><th></th><th>$user Titel</th><th>Text</th><th>Gebruikersnummer</th><th>Laatste update</th><th>Verwijderd</th></tr><tr><td colspan='6'></td></tr>";
