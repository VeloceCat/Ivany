                ...
                @if (isset($_POST['id']))
                    <div class="panel panel-default">
                        ...
                        <div class="panel-content">
                            ...
                            <!-- New Task Form -->
                            <form action="{{ route('adminEdit') }}" method="POST" class="form-horizontal">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="form-group">
                                    <label for="body" class="col-sm-3 control-label"><?php if($_POST['table'] == 'articles') {echo 'Artikel';} elseif ($_POST['table'] == 'quotes') {echo 'Quote';}; ?></label>
