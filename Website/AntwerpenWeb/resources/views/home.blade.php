    ...
    <section>
        <div id="homeText">
            <div class="textFullWidth">
                ...
                <p>Bezoek onze info pagina voor allerlei verhalen. Speel het spel om je te verplaatsen in de schoenen van een slachtoffer.  We willen hierbij slachtoffers helpen, omstaanders leren begrijpen en mensen waarschuwen. Voor hulp kan je op ons forum of op de contactpagina terecht.</p>
            </div>
        </div>
        <div id="buttons">
