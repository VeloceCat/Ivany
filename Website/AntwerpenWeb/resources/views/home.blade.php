    ...
    <section>
        <div id="homeText">
            <div class="textFullWidth">
                ...
                <p>Bezoek de info pagina voor allerlei verhalen. Speel het spel om in de schoenen van een slachtoffer te staan.  We willen hierbij slachtoffers helpen, omstaanders leren begrijpen en mensen waarschuwen. Voor hulp kan je op het forum of op de contactpagina terecht.</p>
            </div>
        </div>
        <div id="buttons">
